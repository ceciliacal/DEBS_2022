...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              crossoverEvents_ = new java.util.ArrayList<CrossoverEvent>();
              mutable_bitField0_ |= 0x00000001;
            }
            crossoverEvents_.add(
                input.readMessage(CrossoverEvent.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ChallengerProto.internal_static_Challenger_ResultQ2_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ChallengerProto.internal_static_Challenger_ResultQ2_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ResultQ2.class, ResultQ2.Builder.class);
  }
  ...
  private java.util.List<CrossoverEvent> crossoverEvents_;
  /**
   * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
   */
  @java.lang.Override
  public java.util.List<CrossoverEvent> getCrossoverEventsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends CrossoverEventOrBuilder>
   ...
   */
  @java.lang.Override
  public CrossoverEvent getCrossoverEvents(int index) {
   ...
   */
  @java.lang.Override
  public CrossoverEventOrBuilder getCrossoverEventsOrBuilder(
      int index) {
    return crossoverEvents_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ResultQ2)) {
      return super.equals(obj);
    }
    ResultQ2 other = (ResultQ2) obj;
  ...
  public static ResultQ2 parseFrom(
  ...
  public static ResultQ2 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ResultQ2 parseFrom(
  ...
  public static ResultQ2 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ResultQ2 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ResultQ2 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ResultQ2 prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public ResultQ2 getDefaultInstanceForType() {
      return ResultQ2.getDefaultInstance();
    }

    @java.lang.Override
    public ResultQ2 build() {
      ResultQ2 result = buildPartial();
    ...
    @java.lang.Override
    public ResultQ2 buildPartial() {
      ResultQ2 result = new ResultQ2(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ResultQ2) {
        return mergeFrom((ResultQ2)other);
      } else {
    ...
    public Builder mergeFrom(ResultQ2 other) {
      if (other == ResultQ2.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ResultQ2 parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ResultQ2) e.getUnfinishedMessage();
    ...
    private void ensureCrossoverEventsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        crossoverEvents_ = new java.util.ArrayList<CrossoverEvent>(crossoverEvents_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
            CrossoverEvent, CrossoverEvent.Builder, CrossoverEventOrBuilder> crossoverEventsBuilder_;
    ...
    public Builder setCrossoverEvents(
        int index, CrossoverEvent value) {
      if (crossoverEventsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setCrossoverEvents(
        int index, CrossoverEvent.Builder builderForValue) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public Builder addCrossoverEvents(CrossoverEvent value) {
      if (crossoverEventsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addCrossoverEvents(
        CrossoverEvent.Builder builderForValue) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
    ...
    public Builder addAllCrossoverEvents(
        java.lang.Iterable<? extends CrossoverEvent> values) {
      if (crossoverEventsBuilder_ == null) {
        ensureCrossoverEventsIsMutable();
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public CrossoverEvent.Builder getCrossoverEventsBuilder(
        int index) {
     ...
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public CrossoverEvent.Builder addCrossoverEventsBuilder() {
      return getCrossoverEventsFieldBuilder().addBuilder(
          CrossoverEvent.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public CrossoverEvent.Builder addCrossoverEventsBuilder(
        int index) {
      return getCrossoverEventsFieldBuilder().addBuilder(
          index, CrossoverEvent.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.CrossoverEvent crossover_events = 3;</code>
     */
    public java.util.List<CrossoverEvent.Builder>
         getCrossoverEventsBuilderList() {
      return getCrossoverEventsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
            CrossoverEvent, CrossoverEvent.Builder, CrossoverEventOrBuilder>
        getCrossoverEventsFieldBuilder() {
      if (crossoverEventsBuilder_ == null) {
  ...
  private static final ResultQ2 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ResultQ2();
  }

  public static ResultQ2 getDefaultInstance() {

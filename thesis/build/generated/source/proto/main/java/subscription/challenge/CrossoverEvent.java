...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ChallengerProto.internal_static_Challenger_CrossoverEvent_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ChallengerProto.internal_static_Challenger_CrossoverEvent_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            CrossoverEvent.class, CrossoverEvent.Builder.class);
  }
  ...
  public enum SignalType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return CrossoverEvent.getDescriptor().getEnumTypes().get(0);
    }
   ...
   */
  @java.lang.Override public SecurityType getSecurityType() {
    @SuppressWarnings("deprecation")
    SecurityType result = SecurityType.valueOf(securityType_);
   ...
   */
  @java.lang.Override public CrossoverEvent.SignalType getSignalType() {
    @SuppressWarnings("deprecation")
    CrossoverEvent.SignalType result = CrossoverEvent.SignalType.valueOf(signalType_);
    return result == null ? CrossoverEvent.SignalType.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (securityType_ != SecurityType.Equity.getNumber()) {
      output.writeEnum(3, securityType_);
    }
    if (signalType_ != CrossoverEvent.SignalType.Buy.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof CrossoverEvent)) {
      return super.equals(obj);
    }
    CrossoverEvent other = (CrossoverEvent) obj;
  ...
  public static CrossoverEvent parseFrom(
  ...
  public static CrossoverEvent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static CrossoverEvent parseFrom(
  ...
  public static CrossoverEvent parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static CrossoverEvent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static CrossoverEvent parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(CrossoverEvent prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public CrossoverEvent getDefaultInstanceForType() {
      return CrossoverEvent.getDefaultInstance();
    }

    @java.lang.Override
    public CrossoverEvent build() {
      CrossoverEvent result = buildPartial();
    ...
    @java.lang.Override
    public CrossoverEvent buildPartial() {
      CrossoverEvent result = new CrossoverEvent(this);
      if (tsBuilder_ == null) {
        result.ts_ = ts_;
      } else {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof CrossoverEvent) {
        return mergeFrom((CrossoverEvent)other);
      } else {
    ...
    public Builder mergeFrom(CrossoverEvent other) {
      if (other == CrossoverEvent.getDefaultInstance()) return this;
      if (other.hasTs()) {
        mergeTs(other.getTs());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      CrossoverEvent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (CrossoverEvent) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
     ...
     */
    @java.lang.Override
    public CrossoverEvent.SignalType getSignalType() {
      @SuppressWarnings("deprecation")
      CrossoverEvent.SignalType result = CrossoverEvent.SignalType.valueOf(signalType_);
      return result == null ? CrossoverEvent.SignalType.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setSignalType(CrossoverEvent.SignalType value) {
      if (value == null) {
        throw new NullPointerException();
      }
  ...
  private static final CrossoverEvent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new CrossoverEvent();
  }

  public static CrossoverEvent getDefaultInstance() {

...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              indicators_ = new java.util.ArrayList<Indicator>();
              mutable_bitField0_ |= 0x00000001;
            }
            indicators_.add(
                input.readMessage(Indicator.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ChallengerProto.internal_static_Challenger_ResultQ1_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ChallengerProto.internal_static_Challenger_ResultQ1_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ResultQ1.class, ResultQ1.Builder.class);
  }
  ...
  private java.util.List<Indicator> indicators_;
  /**
   * <code>repeated .Challenger.Indicator indicators = 3;</code>
   */
  @java.lang.Override
  public java.util.List<Indicator> getIndicatorsList() {
    return indicators_;
  }
  /**
   * <code>repeated .Challenger.Indicator indicators = 3;</code>
   */
  @java.lang.Override
  public java.util.List<? extends IndicatorOrBuilder>
   ...
   */
  @java.lang.Override
  public Indicator getIndicators(int index) {
   ...
   */
  @java.lang.Override
  public IndicatorOrBuilder getIndicatorsOrBuilder(
      int index) {
    return indicators_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ResultQ1)) {
      return super.equals(obj);
    }
    ResultQ1 other = (ResultQ1) obj;
  ...
  public static ResultQ1 parseFrom(
  ...
  public static ResultQ1 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ResultQ1 parseFrom(
  ...
  public static ResultQ1 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ResultQ1 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ResultQ1 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ResultQ1 prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public ResultQ1 getDefaultInstanceForType() {
      return ResultQ1.getDefaultInstance();
    }

    @java.lang.Override
    public ResultQ1 build() {
      ResultQ1 result = buildPartial();
    ...
    @java.lang.Override
    public ResultQ1 buildPartial() {
      ResultQ1 result = new ResultQ1(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ResultQ1) {
        return mergeFrom((ResultQ1)other);
      } else {
    ...
    public Builder mergeFrom(ResultQ1 other) {
      if (other == ResultQ1.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ResultQ1 parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ResultQ1) e.getUnfinishedMessage();
    ...
    private void ensureIndicatorsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        indicators_ = new java.util.ArrayList<Indicator>(indicators_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
            Indicator, Indicator.Builder, IndicatorOrBuilder> indicatorsBuilder_;
     ...
     */
    public Builder setIndicators(
        int index, Indicator.Builder builderForValue) {
      if (indicatorsBuilder_ == null) {
        ensureIndicatorsIsMutable();
     ...
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public Builder addIndicators(Indicator value) {
      if (indicatorsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addIndicators(
        Indicator.Builder builderForValue) {
      if (indicatorsBuilder_ == null) {
        ensureIndicatorsIsMutable();
    ...
    public Builder addAllIndicators(
        java.lang.Iterable<? extends Indicator> values) {
      if (indicatorsBuilder_ == null) {
        ensureIndicatorsIsMutable();
     ...
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public Indicator.Builder getIndicatorsBuilder(
        int index) {
     ...
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public Indicator.Builder addIndicatorsBuilder() {
    ...
    public Indicator.Builder addIndicatorsBuilder(
        int index) {
      return getIndicatorsFieldBuilder().addBuilder(
          index, Indicator.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.Indicator indicators = 3;</code>
     */
    public java.util.List<Indicator.Builder>
         getIndicatorsBuilderList() {
      return getIndicatorsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
            Indicator, Indicator.Builder, IndicatorOrBuilder>
        getIndicatorsFieldBuilder() {
      if (indicatorsBuilder_ == null) {
  ...
  private static final ResultQ1 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ResultQ1();
  }

  public static ResultQ1 getDefaultInstance() {
